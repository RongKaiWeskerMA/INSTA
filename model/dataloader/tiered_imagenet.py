...
class tieredImageNet(data.Dataset):
    def __init__(self, setname, args, augment=False):
        ...
        elif args.backbone_class == 'Res10':
            transforms_list = [
                transforms.RandomSizedCrop(size=(224, 224), scale=(0.08, 1.0), ratio=(0.75, 1.3333),
        ...
        elif args.backbone_class == 'Res12' or args.backbone_class == 'Res10' :
            self.transform = transforms.Compose(
                transforms_list + [
